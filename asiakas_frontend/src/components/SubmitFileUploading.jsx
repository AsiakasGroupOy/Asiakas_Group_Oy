...
export default function SubmitFileUploading({ submittingDialogOpen, handleSubmitFileUploadClosed, handleSubmitFileUpload }) {
...
<Dialog
        ...
        <DialogActions sx={{ justifyContent: "space-between", marginLeft: 2, marginRight: 2 }}>
          <Button 
